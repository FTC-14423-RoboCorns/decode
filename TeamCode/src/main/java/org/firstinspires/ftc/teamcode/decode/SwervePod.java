...
public class SwervePod {
    ...
    public void initTurnTo(double angle) {
      ...
      */
        ...
        if (newservopower == oldservopower) {} else {
 ...
 */
    ...
    public void setMotorPower(double power) {
        ...
        if (newmotorpower == oldmotorpower) {} else {
    ...
    public double turnPID(double error) {
        if (error > Math.toRadians(20)) {
            ...
            return .01; //0.07;
        } else if (error < Math.toRadians(-20)) {
            //-40
            return -.01;
        } else if (error < Math.toRadians(-4)) {
            return Math.toDegrees(error) / 320; //80
    ...
    public double readAngle() {
        if (isFlipped) {
            ...
            return (
                Math.toRadians(360) -
                ((((axonencoder.getVoltage() * Math.toRadians(360)) / 3.3) -
                        offset +
                        Math.toRadians(360) +
                        Math.toRadians(180)) %
                    Math.toRadians(360))
            ...
            return (
                Math.toRadians(360) -
                ((((axonencoder.getVoltage() * Math.toRadians(360)) / 3.3) - offset + Math.toRadians(360)) %
                    Math.toRadians(360))
            );
        }
    }
