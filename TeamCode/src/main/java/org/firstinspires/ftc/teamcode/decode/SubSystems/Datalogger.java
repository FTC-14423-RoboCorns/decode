...
from a user's OpMode such as DatalogWrapper.java or a revised version.
...
public class Datalogger {
    ...
    public abstract static class LoggableField {
        ...
        public Datalogger build() {
            ...
            try {
                BufferedCsvWriter bufferedCsvWriter = new BufferedCsvWriter(
                    String.format("/sdcard/FIRST/java/src/Datalogs/%s.txt", filename)
                );
