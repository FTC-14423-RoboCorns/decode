...
public class DecodeRobot {
    /**
     * High-level robot container class. Holds references to all subsystems, sensors,
     * and helpers used by opmodes and autonomous routines. This class centralizes
     * initialization, periodic reads, and high-level commands such as setting the
     * robot pose or controlling LED patterns.
     */
    ...
    public int[] white = new int[] {
        Color.parseColor("white"),
        Color.parseColor("white"),
        Color.parseColor("white"), // fixed typo: parseColor was misspelled
        Color.parseColor("white"),
        Color.parseColor("white"),
        Color.parseColor("white"),
        Color.parseColor("white"),
    ...
    public DecodeRobot(double xPos, double yPos, double angle) {
        /**
         * The constructor currently only stores the initial heading offset. In
         * the future it could create a path follower pre-seeded with x/y.
         * xPos and yPos are accepted for API compatibility but not yet used.
         */
        ...
        this.angle = angle;
        /**
         * Initialize all hardware and subsystems. This should be called from an
         * OpMode's init() method. It sets up hub caching, sensors, subsystems,
         * and starts peripheral services like the Limelight and LED strip.
         *
         * @param hardwareMap the OpMode's HardwareMap used to look up devices
         * @param isReset     whether this init call is part of a reset (unused)
         * @param telem       telemetry instance to report status (unused)
         */
    }
   ...
   */
        ...
        /**
         * Return the robot's fused orientation (yaw) in radians, normalized to
         * [0, 2*pi). The computed orientation combines the stored IMU-derived
         * yaw (`imuAngle`) and the constructor-supplied offset `angle`.
         *
         * @return fused yaw in radians normalized to [0, 2*pi)
         */
    public double getOrientation() {
        ...
        /**
         * Return the raw IMU yaw component (without the constructor offset `angle`),
         * normalized to [0, 2*pi).
         *
         * @return raw IMU yaw in radians normalized to [0, 2*pi)
         */
    public double getRawGyro() {
        ...
        /**
         * Reset our internal yaw offset and re-zero the Sparkfun odometry heading
         * to 0. This does not reset the physical IMU; it clears our tracked
         * offsets so subsequent orientation calculations start from zero.
         */
    }
    ...
    public void resetYaw() {
        ...
        /**
         * Manually reconfigure odometry sensors and zero the tracked heading.
         * Useful when the robot is known to be physically placed at a known
         * heading and you want odometry to align with that reference.
         */
    }
